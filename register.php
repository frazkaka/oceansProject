...
<option>	Övr. enskilda anordn. psykoterapeututb.	</option>
    ...
    <div class="checkbox">
      <label><input type="checkbox"> Jag accepterar <a href ="register.php" onclick="return conditions();">användarvillkoren</href>.</label>
    </div>
